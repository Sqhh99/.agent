# C++ Core Guidelines digest (optional)

Source: Everything Claude Code `skills/cpp-coding-standards` (MIT), itself derived from
https://isocpp.github.io/CppCoreGuidelines/CppCoreGuidelines

Load only when reviewing a hard lifetime/concurrency/template question.
Daily work stays in `cpp-modern-cpp`. Do not paste this file into the system prompt.
