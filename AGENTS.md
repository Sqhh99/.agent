...
Sqhh99 的 agent skill 包。C++ 任务先读 [skills/cpp/cpp-engineering/SKILL.md](skills/cpp/cpp-engineering/SKILL.md)。Qt 界面再读 [skills/qt/qt-engineering/SKILL.md](skills/qt/qt-engineering/SKILL.md)。正式 Word 技术方案再读 [skills/docs/word-document-authoring-engine/SKILL.md](skills/docs/word-document-authoring-engine/SKILL.md)。
...
当前分类：`skills/cpp/`、`skills/qt/`、`skills/github/`、`skills/docs/`。新领域新建 `skills/<area>/`，不要把非 C++ skill 放进 `cpp/`。
